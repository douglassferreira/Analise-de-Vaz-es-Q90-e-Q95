...
## Metodologia
A aquisição dos dados de vazão da estação 58874000 em São Fideélis - RJ por realizada pelo site da **ANA**, onde os dados foram baixados na extensão **txt**. Após o processamento e limpeza dos dados foi exportado um dataframe, também no formato txt, para sua posterior análise. 
